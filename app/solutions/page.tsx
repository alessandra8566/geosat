  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        />
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-y-1/3 tracking-tight text-white text-[55px] w-225 leading-15 flex flex-col items-center">
      ...
      <div
        className="pt-6.5 pb-19 px-17.5 flex flex-col gap-2.5"
        style={{
          ...
          <div className="border-gradient-round-bottom-right p-px mt-2.5 mx-5">
            <div className="p-7.5 flex items-center gap-5 bg-[#1F1D1D] rounded-[12px]">
              <Image
                ...
                height={230}
              />
              <p className="text-xl font-light font-poppins">In response to emergency situation or quick assessment of front line, a drone associate with cloud system provides instantly streaming back to the office for decision making. </p>
            </div>
          </div>
        </div>
        <div>
          ...
          <div className="border-gradient-round-bottom-left p-px mt-2.5 mx-5">
            <div className="p-7.5 flex items-center gap-5 bg-[#1F1D1D] rounded-[12px]">
              <p className="text-xl font-light font-poppins">Drone offers 24/7 surveillance of all the details in complex industrial environment, making the operation more efficiency with less human power. </p>
              <Image
          ...
          <div className="border-gradient-round-bottom-right p-px mt-2.5 mx-5">
            <div className="p-7.5 flex items-center gap-5 bg-[#1F1D1D] rounded-[12px]">
              <Image
                ...
                height={230}
              />
              <p className="text-xl font-light font-poppins">Achieve precise, reliable mapping in a fraction of the time. Our drone solution delivers high-resolution data with intelligent flight performance, empowering every mission with clarity and efficiency. </p>
            </div>
          </div>
        </div>
      </div>
