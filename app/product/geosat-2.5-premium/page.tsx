  ...
  return (
    <div>
          ...
          <div className="max-w-5/6 flex gap-7.5">
            <div className="flex-1">
              <Image
                ...
                className="w-full object-cover"
              />
              <div className="p-5 pt-7.5 pl-1 pr-7.5">
                <p className="text-4xl font-bold leading-1em">GPS DENIED FLYING</p>
                <p className="text-xl font-light text-white/80 pt-3 leading-6">
      ...
      <div>
        ...
        <div
          className="flex justify-center bg-center bg-cover h-131.5"
          style={{
            background: `
